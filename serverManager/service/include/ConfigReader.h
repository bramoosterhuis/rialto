...
public:
    ...
    std::optional<std::string> getProfilerConfig() override;
...
private:
    ...
    void parseProfilerConfig(std::shared_ptr<firebolt::rialto::wrappers::IJsonValueWrapper> root);
    ...
    std::optional<std::string> m_profilerConfig;
};
